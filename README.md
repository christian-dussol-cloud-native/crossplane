...
> Educational repository for learning Crossplane

Part of **CNCF Project Focus** series - exploring cloud-native technologies in depth.

## About This Repository

This repository contains learning materials and educational examples for **Crossplane**, the universal control plane for cloud infrastructure.

**Educational focus.** Real code and examples

### [carousel/](./carousel)
Collection of visual presentations (carousels) illustrating Crossplane concepts.
